...
- `admin.html` lets an admin add, update, or remove a player reservation for a selected date.
...
- `admin.html`, `admin.js`: admin page for adding or removing selected date reservations.
